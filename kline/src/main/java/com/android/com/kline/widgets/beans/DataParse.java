package com.android.com.kline.widgets.beans;
...
public class DataParse {
     ...
     * @param obj
     */
    public void parseKLine1(JSONObject obj) {
        ArrayList<KLineBean> kLineBeans = new ArrayList<>();
        JSONArray list = null;
        try {
            ...
            for (int i = 0; i < count; i++) {
             //   JSONArray dayData = list.optJSONArray(i);
                ...
                try {
                    ...
                    kLineData.date = object.getString("date").split(" ")[0];
                    kLineData.open =(float)object.getDouble("open");
                    kLineData.close = (float)object.getDouble("close");
                    kLineData.high =  (float)object.getDouble("high");
                    kLineData.low = (float)object.getDouble("low");
                    kLineData.vol = (float)object.getDouble("volume");
