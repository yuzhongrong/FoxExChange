package com.android.com.kline.activitys;
...
import com.android.com.kline.fragments.KlineCoinIntroductionFragment;
import com.android.com.kline.fragments.KlineDepthFragment;
import com.android.com.kline.utils.MyUtils;
import com.cjwsc.idcm.flycotablayout.SlidingTabLayoutInner;
import com.cjwsc.idcm.websocket.FoxWebSocketActivity;
...
import com.android.com.kline.widgets.beans.KLineBean;
import com.android.com.kline.widgets.beans.KMAEntity;
import com.android.com.kline.widgets.beans.VMAEntity;
import com.android.com.kline.Constants.ConstantTest;
import com.android.com.kline.listener.CoupleChartGestureListener;
import com.android.com.kline.widgets.kline.MyBottomMarkerView;
import com.android.com.kline.widgets.kline.MyCombinedChart;
import com.android.com.kline.widgets.kline.MyHMarkerView;
import com.android.com.kline.widgets.kline.MyLeftMarkerView;
import com.android.com.kline.utils.VolFormatter;
...
@Route(path = "/kline/activitys/KLineActivity")
public class KLineActivity extends FoxWebSocketActivity {
    ...
    private CommonTabLayout exchange_buttom_commontablayout;
    private SlidingTabLayoutInner exchange_buttom_detail;
    private AutoHeightViewPager exchange_viewpager;

    private  ArrayList<Fragment> fragments3 = new ArrayList<>();
    private  String[] titles=new String[]{"深度图","实时走势","币种介绍"};
    ...
    private void initViews() {
      //  mTvOpen = (TextView) findViewById(R.id.kline_tv_open);x
     //   mTvClose = (TextView) findViewById(R.id.kline_tv_close);
        mTvMax = findViewById(R.id.kline_value_max);
        mTvMin = findViewById(R.id.kline_value_min);
        mTvNum = findViewById(R.id.kline_tv_num);
      //  mTvExchange = (TextView) findViewById(R.id.kline_tv_exchange);
      //  mTvAmount = (TextView) findViewById(R.id.kline_tv_amount);
        mTvSub = findViewById(R.id.exchange_current_cny);
        mTvPercent = findViewById(R.id.kline_tv_percent);
        ...
        mTvKMa5 = findViewById(R.id.view_kline_tv_ma5);
        mTvKMa10 = findViewById(R.id.view_kline_tv_ma10);
        mTvKMa20 = findViewById(R.id.view_kline_tv_ma20);
        mTvKMa30 = findViewById(R.id.view_kline_tv_ma30);

        mIvRefresh = findViewById(R.id.kline_iv_refresh);
        mTvEntity = findViewById(R.id.kline_tv_entity);

        exchange_buttom_commontablayout=findViewById(R.id.exchange_buttom_commontablayout);

        exchange_buttom_detail=findViewById(R.id.exchange_buttom_detail);
        exchange_viewpager=findViewById(R.id.exchange_viewpager);
    ...
    private void initTablayoutDetail() {
        fragments3.add(new KlineDepthFragment());
        fragments3.add(new KlineDepthFragment());
        fragments3.add(new KlineCoinIntroductionFragment());

        exchange_viewpager.setAdapter(new MyPagerAdapter(getSupportFragmentManager()));
        exchange_buttom_detail.setViewPager(exchange_viewpager,titles,getSupportFragmentManager(),fragments3);
        exchange_viewpager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
            ...
            public void onPageSelected(int position) {
                exchange_viewpager.requestLayout();
            }
    ...
    private void initTablayout(){
        ...
        CustomTabEntity minus = new CustomTabEntity() {
            @Override
            public String getTabTitle() {
                return getString(R.string.str_exchange_minus_hour);
            }
        ...
        CustomTabEntity m15 = new CustomTabEntity() {
            @Override
            public String getTabTitle() {
                return getString(R.string.str_15m);
            }
        ...
        CustomTabEntity h1 = new CustomTabEntity() {
            @Override
            public String getTabTitle() {
                return getString(R.string.str_1h);
            }
        ...
        CustomTabEntity h4 = new CustomTabEntity() {
            @Override
            public String getTabTitle() {
                return getString(R.string.str_4h);
            }
        ...
        CustomTabEntity d1 = new CustomTabEntity() {
            @Override
            public String getTabTitle() {
                return getString(R.string.str_1d);
            }
        ...
        datas.add(h4);
        datas.add(d1);
        exchange_buttom_commontablayout.setTabData(datas);
    ...
    private void initChartKline() {
        ...
        mChartKline.setBorderColor(getResources().getColor(R.color.color_262B43));//边线颜色
        mChartKline.setDescription("");//右下角对图表的描述信息
        mChartKline.setMinOffset(0f);
        mChartKline.setExtraOffsets(0f, 5f, 0f, 3f);
        ...
        xAxisKline.setAxisLineColor(getResources().getColor(R.color.color_262B43));
        xAxisKline.setGridColor(getResources().getColor(R.color.color_262B43));
        xAxisKline.setSpaceBetweenLabels(10);
        //xAxisKline.setSpaceBetweenLabels(getResources().getDimensionPixelOffset(R.dimen.dp3));
      //  xAxisKline.enableGridDashedLine(10f, 10f, 0f);//虚线表示X轴上的刻度竖线(float lineLength, float spaceLength, float phase)三个参数，1.线长，2.虚线间距，3.虚线开始坐标
        ...
        xAxisKline.setTextColor(getResources().getColor(R.color.color_6470A9));//设置字的颜色
        xAxisKline.setTextSize(8f);
...
//        axisLeftKline.setDrawZeroLine(false);
    ...
    //    axisLeftKline.setTextColor(getResources().getColor(R.color.color_6470A9));
//        axisLeftKline.setGridColor(getResources().getColor(R.color.minute_grayLine));
      ...
      //  axisLeftKline.setLabelCount(5, true); //第一个参数是Y轴坐标的个数，第二个参数是 是否不均匀分布，true是不均匀分布
     //   axisLeftKline.setSpaceTop(10);//距离顶部留白
        ...
        axisRightKline.setGridColor(getResources().getColor(R.color.color_262B43));
        axisRightKline.setLabelCount(5, true); //第一个参数是Y轴坐标的个数，第二个参数是 是否不均匀分布，true是不均匀分布
        axisRightKline.setDrawTopYLabelEntry(true);
        axisRightKline.setAxisMaxValue(200f);
        axisRightKline.setAxisMinValue(0f);
        axisRightKline.setPosition(YAxis.YAxisLabelPosition.INSIDE_CHART);
        axisRightKline.setTextColor(getResources().getColor(R.color.color_6470A9));
    ...
    private void initChartVolume() {
        ...
        mChartVolume.setBorderColor(getResources().getColor(R.color.color_262B43));//边框颜色
...
//        axisLeftVolume.setShowOnlyMinMax(true);
    ...
    //    axisLeftVolume.enableGridDashedLine(30f, 10f, 0f);
        axisLeftVolume.setTextColor(getResources().getColor(R.color.color_6470A9));
...
//        axisLeftVolume.setSpaceBottom(0);//距离顶部留白
    ...
    private void initChartCharts() {
        ...
        mChartCharts.setBorderColor(getResources().getColor(R.color.color_262B43));//边线颜色
      ...
      //  axisLeftCharts.enableGridDashedLine(10f, 10f, 0f);
        axisLeftCharts.setTextColor(getResources().getColor(R.color.color_6470A9));
 ...
 /*注：setExtraLeft...函数是针对图表相对位置计算，比如A表offLeftA=20dp,B表offLeftB=30dp,则A.setExtraLeftOffset(10),并不是30，还有注意单位转换*/
  ...
  /*注：setExtraRight...函数是针对图表绝对位置计算，比如A表offRightA=20dp,B表offRightB=30dp,则A.setExtraLeftOffset(30),并不是10，还有注意单位转换*/
    ...
    private void setKLineByChart(MyCombinedChart combinedChart) {
        ...
        set.setDecreasingColor(getResources().getColor(R.color.color_006400));//设置开盘价高于收盘价的颜色
        set.setDecreasingPaintStyle(Paint.Style.FILL);
        set.setIncreasingColor(getResources().getColor(R.color.color_cd2626));//设置开盘价地狱收盘价的颜色
        set.setIncreasingPaintStyle(Paint.Style.STROKE);
        set.setNeutralColor(getResources().getColor(R.color.color_006400));//设置开盘价等于收盘价的颜色
        set.setShadowColorSameAsCandle(true);
        set.setHighlightLineWidth(1f);
        set.setHighLightColor(getResources().getColor(R.color.marker_line_bg));
        set.setDrawValues(true);
        set.setValueTextColor(getResources().getColor(R.color.color_00000000));
    ...
    private void setVolumeByChart(MyCombinedChart combinedChart) {
        ...
        String wan = getString(R.string.str_wan_unit);
        String yi = getString(R.string.str_yi_unit);
        int u = 1;
        if (wan.equals(unit)) {
            u = 4;
...
//        combinedChart.getAxisLeft().setAxisMaxValue(mData.getVolmax());
        ...
        list.add(getResources().getColor(R.color.color_cd2626));
        list.add(getResources().getColor(R.color.color_006400));
        set.setColors(list);
...
//        BarData barData = new BarData(mData.getXVals(), set);
        ...
        set.setShadowWidth(1f);
        set.setValueTextSize(10f);
        set.setDecreasingColor(getResources().getColor(R.color.color_006400));
        set.setDecreasingPaintStyle(Paint.Style.FILL);
        set.setIncreasingColor(getResources().getColor(R.color.color_cd2626));
        set.setIncreasingPaintStyle(Paint.Style.STROKE);
        set.setNeutralColor(getResources().getColor(R.color.color_006400));
        set.setShadowColorSameAsCandle(true);
        set.setHighlightLineWidth(1f);
        set.setHighLightColor(getResources().getColor(R.color.marker_line_bg));
        set.setDrawValues(true);
...
//            mTvClose.setText(MyUtils.getDecimalFormatVol(klData.close));
    ...
    protected int getLayoutId() {
        return R.layout.activity_kline_main;
    }
    ...
    protected void onInitView(@Nullable Bundle bundle) {
        ...
        mIvRefresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String entity = getString(R.string.str_entity_macd);
                switch (chartType) {
                    case 1:
                        entity = getString(R.string.str_entity_macd);
                        setMACDByChart(mChartCharts);
                        break;
                    case 2:
                        entity = getString(R.string.str_entity_kdj);
                        setKDJByChart(mChartCharts);
                        break;
                    case 3:
                        entity = getString(R.string.str_entity_wr);
                        setWRByChart(mChartCharts);
                        break;
                    case 4:
                        entity = getString(R.string.str_entity_rsi);
                        setRSIByChart(mChartCharts);
                        break;
                    case 5:
                        entity = getString(R.string.str_entity_boll);
                        setBOLLByChart(mChartCharts);
                        break;
                    case 6:
                        entity = getString(R.string.str_entity_expma);
                        setEXPMAByChart(mChartCharts);
                        break;
                    case 7:
                        entity = getString(R.string.str_entity_dmi);
