//package com.cjwsc.baseweplus.base.ui.view;
//
...
//
//import com.cjwsc.baseweplus.R;
//
//
///**
// * Countdown View 倒计时计时器
...
//
//
//    private boolean isSolidBanck, isSolidCircle;
//
...
//        //设置是否画实心
//        isSolidBanck = ta.getBoolean(R.styleable.CountdownView_isSolidBanck, false);
//        //是否是圆形
//        isSolidCircle = ta.getBoolean(R.styleable.CountdownView_isSolidCircle, false);
//        ta.recycle();
//
...
//
//        // regular time data
//        // pick bg_home_one of gb_home_two (minute and second)
...
//
//        if (isSolidBanck) {
//            mTimeTextBgPaint.setStyle(Paint.Style.FILL);//实心
//        } else {
//            mTimeTextBgPaint.setStyle(Paint.Style.STROKE);//画空心
//        }
//
//
...
//            if (isShowDay) {
//                // draw day background
////                canvas.drawCircle(mTimeBgRadius, mTimeBgRadius, mTimeBgRadius / 2, mTimeTextBgPaint);
//                if (isSolidCircle) {
...
//                if (isSolidCircle) {
//                    canvas.drawCircle(getHeight() / 2, getHeight() / 2, getHeight() / 2, mTimeTextBgPaint);
//                    canvas.drawCircle(getWidth() / 2, getHeight() / 2, getHeight() / 2, mTimeTextBgPaint);
//                    canvas.drawCircle(getWidth() - getHeight() / 2, getHeight() / 2, getHeight() / 2, mTimeTextBgPaint);
//                } else {
...
//    }
//
//    public interfaces OnCountdownEndListener {
//        void onEnd(CountdownView cv);
//    }
//
//    public interfaces OnCountdownIntervalListener {
