...
//                    }
    ...
    public void showError(CharSequence errorMsg) {
        if(tvError == null)
            tvError = (TextView) mLoadingAndRetryLayout.getRetryView().findViewById(R.id.pager_error_msg);
        if (tvError != null) {
    ...
    public PageManager(Object activityOrFragmentOrView, PageListener listener) {
        ...
        //这里将点击事件
        if(retryView.findViewById(R.id.pager_error_retry_btn)!=null){
            retryView = retryView.findViewById(R.id.pager_error_retry_btn);
        }
        listener.setRetryEvent(retryView);
