package com.cjwsc.idcm.widget.pickerview.lib;
...
import com.cjwsc.idcm.widget.pickerview.OnItemSelectedListener;
import com.cjwsc.idcm.widget.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mGravity = array.getInt(R.styleable.wheelview_wheelview_gravity, Gravity.CENTER);
            ...
            dividerColor = array.getColor(R.styleable.wheelview_dividerColor, dividerColor);
            textSize = array.getDimensionPixelOffset(R.styleable.wheelview_textSize, textSize);
            array.recycle();
        }
...
//        try {  此映射导致第一次弹出的时候用了1450ms 卡顿现象
