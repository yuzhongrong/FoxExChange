...
package com.cjwsc.idcm.widget.dripDownView;
...
public class DropListView extends TextView {
    ...
    private boolean isSlefOnItem=false;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mGravity = ta.getInt(R.styleable.MaterialSpinner_ms_text_gravity, Gravity.CENTER);
        ...
        left = right = bottom = top = resources.getDimensionPixelSize(R.dimen.dp10);
        if (rtl) {
            right = resources.getDimensionPixelSize(R.dimen.dp10);
        } else {
            left = resources.getDimensionPixelSize(R.dimen.dp10);
        }
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                if (nothingSelected && onNothingSelectedListener != null) {
                    onNothingSelectedListener.onNothingSelected(DropListView.this);
                }
                if (!hideArrow) {
                    animateArrow(false);
                }
    ...
    public void setBackgroundColor(int color) {
        ...
        if (background instanceof StateListDrawable) { // pre-L
            try {
                ...
                LogUtil.e("MaterialSpinner", "Error setting background color");
            }
    ...
    public void setAdapter(@NonNull ListAdapter adapter,boolean isAddFooter,View footerView,boolean isSlefOnItem) {
        this.footerView=footerView;
        this.isSlefOnItem=isSlefOnItem;
...
//        setAdapterInternal(this.adapter);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                onItemSelectedListener.onItemSelected(null,i,l,view);
            }
        });
    }
    ...
    private int calculatePopupWindowHeight() {
        ...
        float itemHeight = getResources().getDimension(R.dimen.dp40);
    ...
    public interface OnItemSelectedListener<T> {
         ...
         */
        void onItemSelected(DropListView view, int position, long id, T item);
    }
    ...
    public interface OnNothingSelectedListener {
         ...
         */
        void onNothingSelected(DropListView spinner);
    }
}
