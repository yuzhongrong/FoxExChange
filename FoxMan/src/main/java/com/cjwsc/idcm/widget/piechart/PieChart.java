...
import com.cjwsc.idcm.animation.ChartAnimator;
...
//    private float radius;
    ...
    private onPieItemClickListener onPieItemclickListener;
...
//        super.onDraw(canvas);
            ...
            switch (event.getAction()){
                ...
                case MotionEvent.ACTION_UP:
                    if (isDownTouch){
                        ...
                        onPieItemclickListener.onSeletedItem(pieChartRender.getPieData().getName());
                        invalidate();
                        isDownTouch = false;
                        return true;
                    }
    ...
    protected void animated() {
        if (!isAnimated) {
            ...
            mChartAnimator.animatedY(500,360f);
        }
    }
    ...
    public void setPieItemClick(onPieItemClickListener onPieItemClickListener){
        this.onPieItemclickListener=onPieItemClickListener;
    }
}
