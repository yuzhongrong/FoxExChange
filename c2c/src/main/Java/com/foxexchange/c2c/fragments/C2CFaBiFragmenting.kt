 ...
 * 法币订单 进行中
 */
class C2CFaBiFragmenting :BaseKTFragment() {
...
//    var adapter : LQRAdapterForRecyclerView<*> ?= null
    ...
    override val layoutId: Int
        get() = R.layout.fragment_c2c_order_list

    override fun onInitView(bundle: Bundle?) {
        lqr_fb_list = rootView?.findViewById(R.id.my_order_list)

        lqr_fb_list?.adapter = object : LQRAdapterForRecyclerView<Any>(context, list, R.layout.item_c2c_fabi) {
