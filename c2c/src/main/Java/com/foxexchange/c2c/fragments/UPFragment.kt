...
class UPFragment : BaseKTFragment() {
    ...
    override fun onInitView(bundle: Bundle?) {
      ...
      adapter = object : LQRAdapterForRecyclerView<UPBean>(activity, ArrayList<UPBean>(), R.layout.item_up) {
            override fun convert(helper: LQRViewHolderForRecyclerView, item: UPBean, position: Int) {

                helper.getView<TextView>(R.id.buy).setOnClickListener {ARouter.getInstance()
