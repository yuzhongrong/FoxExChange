...
public class C2CTradeOutFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_trade_out;
    }
    ...
    protected void onInitView(Bundle bundle) {
        ...
        fragmentList.add(new UPFragmentOut());
        fragmentList.add(new USDTFragmentOut());
